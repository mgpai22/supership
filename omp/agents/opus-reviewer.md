...
- Report EVERY finding you judge real, including lower-severity and lower-confidence
  ones, and tag each with a confidence and severity so a downstream judge can rank
  them. Do not silently drop a finding because it seems minor — filtering happens
  after you, not inside you.
